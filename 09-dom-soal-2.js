...
<body>
  <div class="container py-5">
    <div class="row">
      ...
      <div class="col-6">
        <ul id="comment-list" class="list-group list-group-flush overflow-auto" style="height: 220px">
          <li class="
                list-group-item
                d-flex
      ...
      <div id="comment-form-section" class="col-12 d-none">
        <form id="comment-form">
          ...
          <div>
            ...
            <button id="btn-cancel" type="button" class="btn btn-link text-decoration-none">
              cancel
            </button>
          </div>
        </form>
  ...
  <script>
    ...
    // ----------- Answer -----------
    // Memberikan eventListener "click" pada comment button
    elBtnComment.addEventListener("click", function () {
      elCommentSection.classList.remove("d-none");
      elBtnComment.classList.add("d-none");
    });

    // Memberikan eventListener "click" pada submit button
    elBtnSubmit.addEventListener("click", function (a) {
      a.preventDefault();
      ...
      const cloneDiv = divCommentList.cloneNode(true);
      cloneDiv.firstElementChild.innerText = username;
      cloneDiv.childNodes[2].textContent = comment;

      const newComment = document.createElement("li");
      newComment.classList.add("list-group-item", "d-flex", "justify-content-between", "align-items-start");
      newComment.append(cloneDiv);
    ...
    // Memberikan eventListener "click" pada cancel button
    elBtnCancel.addEventListener("click", function (b) {
      b.preventDefault();
